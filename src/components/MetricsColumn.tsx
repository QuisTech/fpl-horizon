      ...
      <div className="bg-card-bg border border-fpl-border rounded-3xl p-5 shadow-sm">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center text-[11px]">
            ...
            <span className="font-bold text-white">Multi-Horizon Beam Search</span>
          </div>
          <div className="flex justify-between items-center text-[11px]">
          ...
          <div className="flex justify-between items-center text-[11px]">
            ...
            <span className="font-bold text-white">Predictive Base xP</span>
          </div>
          <div className="flex justify-between items-center text-[11px]">
            <span className="text-slate-400">Ownership Bias</span>
            <span className="font-bold text-white">Smooth EO Scaling (+15-25%)</span>
          </div>
          <div className="flex justify-between items-center text-[11px]">
