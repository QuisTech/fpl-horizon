  ...
  return (
    <header className="col-span-12 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center justify-between mb-4">
      <div className="flex items-center gap-4">
        <div className="w-10 h-10 bg-fpl-purple rounded flex items-center justify-center font-black text-xl text-white shadow-lg shadow-fpl-purple/20 shrink-0">H</div>
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <h1 className="text-2xl font-bold tracking-tight">FPL <span className="text-fpl-green">HORIZON</span></h1>
            <span className="bg-fpl-pink text-white text-[8px] font-black px-1.5 py-0.5 rounded shadow-sm shadow-fpl-pink/20">GRAND CRU</span>
          ...
          <p className="text-[10px] text-slate-500 font-light uppercase tracking-widest">Strategist + Grand Cru product ladder</p>
        </div>
      </div>
